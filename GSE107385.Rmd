...
* Expressão diferencial de MicroArrays
  - Foi utilizado para obter as matrizes de contagem normalizadas o pacote **oligo** do Bioconductor.
...
# Expressão diferencial de MicroArray
...
Agora, vamos rodar a análise em si.
